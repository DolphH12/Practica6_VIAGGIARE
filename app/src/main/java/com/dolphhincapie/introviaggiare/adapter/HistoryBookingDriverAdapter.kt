...
class HistoryBookingDriverAdapter(
    options: FirebaseRecyclerOptions<HistoryBooking>,
    private val onItemClickListener: HistoryBookingDriverAdapter.OnItemClickListener
) : FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingDriverAdapter.ViewHolder>(options) {
    ...
    class ViewHolder(
        ...
        fun historyData(historyBooking: HistoryBooking, id: String) {
            mId = id
            itemView.tv_originHistory.text = historyBooking.origin
            itemView.tv_destinationHistory.text = historyBooking.destination
            itemView.tv_calificationHistory.text = historyBooking.CalificationDriver.toString()
